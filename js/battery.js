...
function updateBatteryStatus(battery) {
    ...
    chargeLevel.textContent = chargeMeter.value + "%";

    const batteryLevelForImage = chargeMeter.value; 
    const batteryImageUrl = `https://robohash.org/${batteryLevelForImage}.png`;
    document.getElementById('batteryImage').src = batteryImageUrl;
}
